...
<>
    ...
    >
      <div className=" items-center w-[100%]   p-[1rem]  transition-all">
        <div className="h-full text-center flex  gap-5  justify-between items-center">
          ...
          >
            <ul className="flex gap-5 uppercase text-[15px] text-[#111] tracking-widest leading-6 font-lightbold">
          ...
          <div className="w-[8rem]">
            <img
              src={logo}
              alt=""
              className="h-[2.3rem] w-[] lg:ml-[24%] items-center "
            />
          </div>
          <div
            className="flex gap-3  max-md:hidden "
          ...
          <div onClick={()=>setMenu(true)} className="hidden max-md:block  text-[3rem] cursor-pointer hover:text-blue-600">
            <MdOutlineMenu />
          </div>
  ...
  {menu && <div className="flex  fixed w-full h-[100vh] bg-[#000000f3] z-40 ">
    <div className="flex w-[100%] relative justify-center items-center">
    <IoCloseSharp onClick={()=>setMenu(false)} className="absolute right-10 text-white top-10 text-lg hover:text-red-500 transition-all"/>
      <div className="flex justify-center text- tracking-wider uppercase text-center text-white" style={{fontFamily:'Lora'}}>
