  ...
  return (
    <div className='md:py-[3rem] max-md:py-[1.5rem] md:px-[5%] xl:px-[15%] max-md:px-3 '>
      ...
      max-w-[1320px] gap-2 md:h-[10rem]  object-cover box-content overflow-hidden'>
        ...
        <img src={require('../../assets/unoptiImages/pw6.jpg')} alt="" className='max-md:h-[130px] h-[100%] w-[100%] object-cover' />
        </motion.div>
        <motion.img 
        viewport={{once:true}} initial={{scale:0}} whileInView={{scale:1,transition:{type:'spring',ease:'easeIn',duration:1,delay:0.5}}}
        src={require('../../assets/unoptiImages/pw4.jpg')} alt=""  className='object-cover h-[100%] w-[100%] max-md:h-[130px] '/>
        <motion.img
        viewport={{once:true}} initial={{scale:0}} whileInView={{scale:1,transition:{type:'spring',ease:'easeIn',duration:1,delay:0.7}}}
        src={require('../../assets/unoptiImages/pw10.jpg')} alt="" className='object-cover h-[100%] w-[100%] max-md:h-[130px] '/>
        <motion.img
        ...
        src={require('../../assets/unoptiImages/11.png')} alt="" className='object-cover h-[100%] max-md:h-[130px] w-[100%]' />
        <motion.img
        viewport={{once:true}} initial={{scale:0}} whileInView={{scale:1,transition:{type:'spring',ease:'easeIn',duration:1,delay:1.3}}}
        src={require('../../assets/unoptiImages/pw9.jpg')} alt="" className='object-cover h-[100%] max-md:h-[130px] w-[100%]'/>
      </div>
    </div>
  )
}
