    ...
    <div className="w-full overflow-hidden flex justify-center items-center box-content  max-md:py-[2rem] md:py-[4rem]">
      <div className="md:flex max-md:flex-col gap-10 justify-center max-w-[1320px] px-[8%] ">
        ...
        <div className="flex flex-col gap-2 justify-center items-center w-[30rem]  pt-[2rem] border-black md:border-l-[1px] md:border-r-[1px] px-[2rem] ">
          ...
          <a href="https://www.facebook.com/neofotomojography/">
...
<div className="flex flex-col uppercase max-md:mt-5 justify-center items-center" style={{fontFamily:'Lora'}}>
    ...
    <h4 className="hover:text-blue-600 transition-all cursor-pointer"><Link  to={'/engegment'}>Engagement</Link></h4>
    <h4 className="hover:text-blue-600 transition-all cursor-pointer"><Link  to={'/wedding'}>wedding</Link></h4>
    <h4 className="hover:text-blue-600 transition-all  cursor-pointer"> <Link to={'/pre-wedding'}>pre-wedding</Link></h4>
</div>
