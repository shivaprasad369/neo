  ...
  return (
    <div id='contact' className='xl:h-[35rem] max-md:h-[20rem] relative overflow-hidden w-[100%]'>
      <div className='flex h-full w-[100%] justify-center'>
        ...
        <motion.div  viewport={{once:true}} initial={{scale:0.8}} whileInView={{scale:1,transition:{type:'spring',duration:1,ease:'easeIn'}}} className='absolute flex justify-center bg-white xl:right-[4rem] md:px-[3rem] max-md:px-[2rem] mx-[3%] top-[30%]
