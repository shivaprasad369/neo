...
import {
  ...
  EffectFade,
} from "swiper/modules";import { useLocation } from "react-router-dom";
    ...
    <div id='home' className='h-[100%] flex w-[100%] relative justify-center items-center overflow-hidden py-[5rem]'>
      <div className='flex w-[100%] max-w-[1320px] justify-center items-center h-fit'>
        ...
        <Swiper
          ...
          className="mySwiper justify-center items-center max-w-[1320px] h-[100%] "
        >
          <SwiperSlide>
            <img src={require('./images/achyut and revati1.jpg')} className='object-cover w-[100%] h-[100%]' alt="" />
        </SwiperSlide>
        <SwiperSlide>
            <img src={require('./images/wedding2.jpg')} className='object-cover w-[100%] h-[100%]' alt="" />
        </SwiperSlide>
        <SwiperSlide>
            <img src={require('./images/wedding3.jpeg')} className='object-cover w-[100%] h-[100%]' alt="" />
        </SwiperSlide>
        {/* <SwiperSlide>
            <img src={require('../../assets/unoptiImages/eg2.jpg')} alt="" />
        </SwiperSlide> */}
        <SwiperSlide>
            <img src={require('./images/wedding4.jpeg')} className='object-cover w-[100%] h-[100%]' alt="" />
        </SwiperSlide>
        </Swiper>
        </div>
      </div>
      <div style={{fontFamily:'Antic Didone'}} className='absolute bottom-2 tracking-wider z-20 justify-center items-center lg:w-[50%] w-[80%]  text-center border-[3px] border-white bg-[#272727] text-white'>
        <div className='flex flex-col px-[2rem] py-[1rem]'>
            <motion.h4 viewport={{once:true}} initial={{scale:0.4}} whileInView={{scale:1,transition:{type:'spring',ease:'easeIn',duration:1.5}}} className='md:text-[3rem] max-md:text-[2rem] max-sm:text-[1.5rem]'>WEDDING</motion.h4>
